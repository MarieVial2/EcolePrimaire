...
class ElevesRepository extends ServiceEntityRepository
{
    ...
    //Utiliser le QueryBulder pour effectuer une requete spécifique à la base de données : selectionner les eleves selon l'id de la classe
    public function findClasseById($id): array
       {
           return $this->createQueryBuilder('e')
               ->andWhere('e.classe = :val')
               ->setParameter('val', $id)
